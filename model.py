...
class ft_net(nn.Module):
    ...
    '''
        :param class_num 行人的种类（Market1501数据集有751中不同种类的人），ImageNet有1000类
    '''
    def __init__(self, class_num, droprate=0.5, stride=2):
        super(ft_net, self).__init__()
        model_ft = models.resnet50(pretrained=True)    # 基于ImageNet预训练模型的基础上再次训练
...
# Test the model, before you train it. 
    net = ft_net(751, stride=1)    # Market1501数据集有751种不同的人
